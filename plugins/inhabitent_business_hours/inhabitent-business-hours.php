 ...
 * Plugin URI:        @TODO
 * Description:       Widget to generate business hours
 * Version:           1.0.0
 * Author:            Kyle Tecson
 * Author URI:        @TODO
 * License:           GPL-2.0+
...
class Inhabitent_Business_Hours extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'A widget that will show business hours.'
			)
		);
	...
	public function widget( $args, $instance ) {
		...
		$monday_friday = empty( $instance['monday_friday'] ) ? '' : apply_filters( 'moday_friday', $instance['monday_friday'] );
